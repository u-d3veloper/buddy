    ...
    <div className="bg-gray-50 h-screen">
      ...
      <div className="container flex justify-center flex-col">
        {loading ? (
          ...
          <ul>
            <a href="/eventInfo"><li className='active:bg-gray-200 border-2 border-gray-700 border-dashed rounded-3xl mx-3 my-2 py-6 flex justify-center align-center'>
            ...
            {data.map(item => (
              <a href={`/eventInfo/${item.id}`} key={item.id}>
                ...
                <div className='flex flex-col justify-center ml-2'>
                  ...
                  <p>Date : {new Date(item.date.seconds * 1000).toLocaleDateString()}</p>
